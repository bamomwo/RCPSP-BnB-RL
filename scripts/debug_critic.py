...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--alpha", type=float, default=0.01, help="Cost per node.")
    p.add_argument("--beta1", type=float, default=1.0, help="First-incumbent bonus weight.")
    p.add_argument("--beta2", type=float, default=1.0, help="Improvement bonus weight.")
